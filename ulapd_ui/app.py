from ulapd_ui.landregistry_flask import LandRegistryFlask
...
app.jinja_loader = PrefixLoader({
    'app': PackageLoader('ulapd_ui'),
    'wtforms_gov': PackageLoader('ulapd_ui.custom_extensions.wtforms_helpers')
})
...
def inject_global_values():
    ...
    return dict(
        service_name='Use land and property data',
        ga_key=app.config["GA_KEY"]
    )

...
# from ulapd_ui.custom_extensions.content_security_policy.main import ResponseWithoutCSP
...
#     @mock.patch('ulapd_ui.custom_extensions.content_security_policy.main.ContentSecurityPolicy.init_app')
...
#     @mock.patch('ulapd_ui.custom_extensions.content_security_policy.reporting.logger.error')

...
# from ulapd_ui.custom_extensions.cachebust_static_assets.main import md5_for_file
...
#     @mock.patch('ulapd_ui.custom_extensions.cachebust_static_assets.main.CachebustStaticAssets.init_app')
...
#         filename = 'ulapd_ui/assets/dist/test.txt'
#         with open(filename, 'w+') as file:
#             file.write('Hello')
...
#     @mock.patch('ulapd_ui.custom_extensions.cachebust_static_assets.main.md5_for_file', wraps=md5_for_file)
...
#         filename = 'ulapd_ui/assets/dist/test.css'
#         with open(filename, 'w+') as file:
#             file.write('Hello')

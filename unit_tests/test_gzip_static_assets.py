...
# from ulapd_ui.custom_extensions.gzip_static_assets.main import gzip_cache
# from ulapd_ui.custom_extensions.gzip_static_assets.main import gzip_cache_key
...
#     @mock.patch('ulapd_ui.custom_extensions.gzip_static_assets.main.GzipStaticAssets.init_app')
...
#         # Create test file
#         filename = 'ulapd_ui/assets/dist/gzip-test.css'
